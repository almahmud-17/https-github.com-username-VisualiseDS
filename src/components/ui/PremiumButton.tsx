    ...
    ({ className, variant = "primary", loading, children, ...props }, ref) => {
        ...
        return (
            <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={cn(
                    "relative overflow-hidden px-6 py-2.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed",
